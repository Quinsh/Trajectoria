...
async function getCareerPaths(file) {
  ...
  const prompt =
    "Take this resume and tell me in just one word what career path is suitable for me. Be as specific as possible. For example, AI researcher instead of researcher. Just output the position name I should target and nothing else. Comma separated. Give top 5 options. ";
